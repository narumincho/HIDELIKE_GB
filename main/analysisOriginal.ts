...
const INIT = () => {
    ...
    for (let i = 10; i < 20; i++) {
        ...
        SPANIM(
            SPNUM_ENEMY + i,
            "UV",
            [[16, 00, 208], [16, 16, 208], [16, 32, 208], [16, 48, 208]],
            0
        );
        SPHIDE(SPNUM_ENEMY + i);
    }
    for (let i = 20; i < 30; i++) {
        ...
        SPANIM(
            SPNUM_ENEMY + i,
            "UV",
            [[16, 00, 128], [16, 16, 128], [16, 32, 128], [16, 48, 128]],
            0
        );
        SPHIDE(SPNUM_ENEMY + i);
    }
    for (let i = 30; i < 40; i++) {
        ...
        SPANIM(
            SPNUM_ENEMY + i,
            "UV",
            [[16, 00, 160], [16, 16, 160], [16, 32, 160], [16, 48, 160]],
            0
        );
        SPHIDE(SPNUM_ENEMY + i);
    }
    for (let i = 40; i < 50; i++) {
        ...
        SPANIM(
            SPNUM_ENEMY + i,
            "UV",
            [[60, 00, 336], [16, 16, 336], [16, 32, 336], [16, 48, 336]],
            0
        );
        if (44 < i) {
    ...
    for (let i = 50; i < 60; i++) {
        ...
        SPANIM(
            SPNUM_ENEMY + i,
            "UV",
            [[60, 00, 320], [16, 16, 320], [16, 32, 320], [16, 48, 320]],
            0
        );
        SPHIDE(SPNUM_ENEMY + i);
    }
    for (let i = 60; i < 70; i++) {
        ...
        SPANIM(
            SPNUM_ENEMY + i,
            "UV",
            [[60, 00, 368], [16, 16, 368], [16, 32, 368], [16, 48, 368]],
            0
        );
        SPHIDE(SPNUM_ENEMY + i);
    }
    for (let i = 70; i < 80; i++) {
        ...
        SPANIM(
            SPNUM_ENEMY + i,
            "UV",
            [[60, 00, 352], [16, 16, 352], [16, 32, 352], [16, 48, 352]],
            0
        );
        SPHIDE(SPNUM_ENEMY + i);
    }
    for (let i = 80; i < 90; i++) {
        ...
        SPANIM(
            SPNUM_ENEMY + i,
            "UV",
            [[16, 00, 416], [16, 16, 416], [16, 32, 416], [16, 48, 416]],
            0
        );
        SPHIDE(SPNUM_ENEMY + i);
    }
